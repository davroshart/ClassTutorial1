...
namespace Gallery3SelfHost
{
    public class GalleryController : System.Web.Http.ApiController
    {
        ...
        public string PostArtist(clsArtist prArtist)
        {
            try
            {
                int lcRecCount = clsDbConnection.Execute(
                   ...
                   "INSERT Artist (Name, Speciality, Phone)" +
        ...
        private Dictionary<string, object> prepareArtistParameters(string prName)
        {
            Dictionary<string, object> par = new Dictionary<string, object>(1);
            par.Add("Name", prName);
            return par;
        ...
        private Dictionary<string, object> prepareWorkParameters(string prName, string prArtistName)
        {
